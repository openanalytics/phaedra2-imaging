...
public class Kdu_region_decompressor {
  ...
  {
    return Process(_buffer,_channel_offsets,_pixel_gap,_buffer_origin,_row_gap,_suggested_increment,_max_region_pixels,_incomplete_region,_new_region,(boolean) true,(boolean) true,(int) 0,(int) 0,(int) 0);
  }
  ...
  {
    return Process(_buffer,_channel_offsets,_pixel_gap,_buffer_origin,_row_gap,_suggested_increment,_max_region_pixels,_incomplete_region,_new_region,_normalize,(boolean) true,(int) 0,(int) 0,(int) 0);
  }
  ...
  {
    return Process(_buffer,_channel_offsets,_pixel_gap,_buffer_origin,_row_gap,_suggested_increment,_max_region_pixels,_incomplete_region,_new_region,_normalize,_measure_row_gap_in_pixels,(int) 0,(int) 0,(int) 0);
  }
  ...
  {
    return Process(_buffer,_channel_offsets,_pixel_gap,_buffer_origin,_row_gap,_suggested_increment,_max_region_pixels,_incomplete_region,_new_region,_normalize,_measure_row_gap_in_pixels,_expand_monochrome,(int) 0,(int) 0);
  }
  ...
  {
    return Process(_buffer,_channel_offsets,_pixel_gap,_buffer_origin,_row_gap,_suggested_increment,_max_region_pixels,_incomplete_region,_new_region,_normalize,_measure_row_gap_in_pixels,_expand_monochrome,_fill_alpha,(int) 0);
  }
