...
public class Kdu_multi_analysis {
  ...
  public native long Create(Kdu_codestream _codestream, Kdu_tile _tile, Kdu_thread_env _env, Kdu_thread_queue _env_queue, int _flags, Kdu_roi_image _roi, int _buffer_rows) throws KduException;
  public long Create(Kdu_codestream _codestream, Kdu_tile _tile, Kdu_thread_env _env, Kdu_thread_queue _env_queue, int _flags) throws KduException
  {
    ...
    return Create(_codestream,_tile,_env,_env_queue,_flags,roi,(int) 1);
  }
  ...
  {
    return Create(_codestream,_tile,_env,_env_queue,_flags,_roi,(int) 1);
  }
