...
public class Kdu_encoder extends Kdu_push_ifc {
  ...
  private static native long Native_create(Kdu_subband _subband, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, Kdu_roi_node _roi, Kdu_thread_env _env, Kdu_thread_queue _env_queue, int _flags);
  ...
  private static long Native_create(Kdu_subband _subband, Kdu_sample_allocator _allocator, boolean _use_shorts)
  {
    ...
    return Native_create(_subband,_allocator,_use_shorts,(float) 1.0F,roi,env,env_queue,(int) 0);
  }
  ...
  private static long Native_create(Kdu_subband _subband, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization)
  {
    ...
    Kdu_thread_env env = null;
    Kdu_thread_queue env_queue = null;
    return Native_create(_subband,_allocator,_use_shorts,_normalization,roi,env,env_queue,(int) 0);
  }
  ...
  private static long Native_create(Kdu_subband _subband, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, Kdu_roi_node _roi)
  {
    Kdu_thread_env env = null;
    Kdu_thread_queue env_queue = null;
    return Native_create(_subband,_allocator,_use_shorts,_normalization,_roi,env,env_queue,(int) 0);
  }
  ...
  {
    Kdu_thread_queue env_queue = null;
    return Native_create(_subband,_allocator,_use_shorts,_normalization,_roi,_env,env_queue,(int) 0);
  }
  ...
  {
    return Native_create(_subband,_allocator,_use_shorts,_normalization,_roi,_env,_env_queue,(int) 0);
  }
