...
public class Kdu_thread_entity {
  ...
  public native void Create(long _cpu_affinity, boolean _also_set_owner_affinity) throws KduException;
  public void Create() throws KduException
  {
    Create((long) 0,(boolean) true);
  }
  public void Create(long _cpu_affinity) throws KduException
  {
    Create(_cpu_affinity,(boolean) true);
  }
  ...
  public native void Signal_condition(Kdu_thread_entity_condition _cond) throws KduException;
