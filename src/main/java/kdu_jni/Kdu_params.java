...
public class Kdu_params {
  ...
  private static long Native_create(String _cluster_name, boolean _allow_tile_diversity, boolean _allow_component_diversity, boolean _allow_instance_diversity)
  {
    return Native_create(_cluster_name,_allow_tile_diversity,_allow_component_diversity,_allow_instance_diversity,(boolean) false,(boolean) false);
  }
  public Kdu_params(String _cluster_name, boolean _allow_tile_diversity, boolean _allow_component_diversity, boolean _allow_instance_diversity) {
    this(Native_create(_cluster_name, _allow_tile_diversity, _allow_component_diversity, _allow_instance_diversity));
  }
  private static long Native_create(String _cluster_name, boolean _allow_tile_diversity, boolean _allow_component_diversity, boolean _allow_instance_diversity, boolean _force_component_specific_forms)
  {
    return Native_create(_cluster_name,_allow_tile_diversity,_allow_component_diversity,_allow_instance_diversity,_force_component_specific_forms,(boolean) false);
  }
  public Kdu_params(String _cluster_name, boolean _allow_tile_diversity, boolean _allow_component_diversity, boolean _allow_instance_diversity, boolean _force_component_specific_forms) {
    this(Native_create(_cluster_name, _allow_tile_diversity, _allow_component_diversity, _allow_instance_diversity, _force_component_specific_forms));
  }
