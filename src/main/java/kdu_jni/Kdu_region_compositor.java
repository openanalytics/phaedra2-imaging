...
public class Kdu_region_compositor {
  ...
  public native Kdu_compositor_buf Inspect_composition_queue(int _elt, long[] _custom_stamp, int[] _custom_id_val) throws KduException;
  public Kdu_compositor_buf Inspect_composition_queue(int _elt) throws KduException
  {
    return Inspect_composition_queue(_elt,null,null);
  }
  public Kdu_compositor_buf Inspect_composition_queue(int _elt, long[] _custom_stamp) throws KduException
  {
    return Inspect_composition_queue(_elt,_custom_stamp,null);
  }
