...
public class Kdu_codestream {
  ...
  public native void Create(Siz_params _siz, Kdu_compressed_target _target, Kdu_dims _fragment_region, int _fragment_tiles_generated, long _fragment_tile_bytes_generated, Kdu_thread_env _env) throws KduException;
  public void Create(Siz_params _siz, Kdu_compressed_target _target, Kdu_dims _fragment_region) throws KduException
  {
    ...
    Create(_siz,_target,_fragment_region,(int) 0,(long) 0,env);
  }
  ...
  {
    Kdu_thread_env env = null;
    Create(_siz,_target,_fragment_region,_fragment_tiles_generated,(long) 0,env);
  }
  ...
  {
    Kdu_thread_env env = null;
    Create(_siz,_target,_fragment_region,_fragment_tiles_generated,_fragment_tile_bytes_generated,env);
  }
  ...
  public native void Create(Siz_params _siz, Kdu_thread_env _env) throws KduException;
  ...
  public native void Mem_failure(String _mem_category, String _message) throws KduException;
  ...
  public native void Apply_input_restrictions(int _first_component, int _max_components, int _discard_levels, int _max_layers, Kdu_dims _region_of_interest, int _access_mode, Kdu_thread_env _env) throws KduException;
  ...
  {
    Kdu_thread_env env = null;
    Apply_input_restrictions(_first_component,_max_components,_discard_levels,_max_layers,_region_of_interest,_access_mode,env);
  }
  public native void Apply_input_restrictions(int _num_indices, int[] _component_indices, int _discard_levels, int _max_layers, Kdu_dims _region_of_interest, int _access_mode, Kdu_thread_env _env) throws KduException;
  ...
  {
    Kdu_thread_env env = null;
    Apply_input_restrictions(_num_indices,_component_indices,_discard_levels,_max_layers,_region_of_interest,_access_mode,env);
  }
